<template>
    <div :class="showModel == true ? 'abc' : ''">
        ...
        <div class="main_head container w-100 d-flex justify-content-around" id="our_home">
            ...
            <DialogConfirm v-if="showModel == true" @closeModal="closeModal" class="d_confirm m-auto position-fixed">
            </DialogConfirm>
...
.my_btn:hover {
    background-color: rgba(139, 0, 0, 0.855);
    box-shadow: 5px 5px 15px rgba(45, 6, 6, 0.539);
}

.my_player {
    width: 48px;
    height: 48px;
    background-color: rgb(236, 221, 255);
    border-radius: 50%;
    margin-right: 20px;
    position: relative;
    cursor: pointer;
...
.my_player::before {
    ...
    /* clip-path: polygon(43% 0, 42% 100%, 100% 51%); */
    clip-path: polygon(20% 0, 19% 100%, 100% 51%);
    background-color: darkred;
}
